...
function displayTrackStats(track){
  console.log(track);
  console.log(convertUnixToText(track.lastPlayDate));
  var trackStats =
  "<a target=\"_blank\" rel=\"noopener noreferrer\" href=\"" + track.track.external_urls.spotify + "\"><img id=\"albumThumb\" src="+ track.track.album.images[0].url +" height=\"250px\"></a><h3 id=\"trackTitle\">" + track.track.name + "</h3><span class=\"trackFacts\">by "+ track.track.artists[0].name +"</span><br><span class=\"trackFacts\">from "+ track.track.album.name + "</span><br><br><span class=\"trackStatistics\">Added on "+ convertIsoToLastPlayed(track.added_at) +".</span><br><span class=\"trackStatistics\">Played "+ track.activeStat.counter + " times in the last </span><span id=\"dateRange\" class=\"trackStatistics\">" + track.activeStat.spanText + ".</span><br>"
